...
from src.views import download_form, check_task
...
urlpatterns = [
    ...
    path('api/v1/visaApplication/', include('src.visaapplication.urls')),
    path('api/v1/task/', check_task, name="check_task"),
    # auth
    path('api-auth/', include('rest_framework.urls', namespace='rest_framework')),
    path('api/v1/token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),
    path('api/v1/token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    # downloads
    path('df/<str:file>/', download_form, name="download_pdf"),
    # social login
